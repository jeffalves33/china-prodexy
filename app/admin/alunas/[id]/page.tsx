        ...
        <section className="pt-4 bg-white rounded-lg p-4 border border-(--color-border)">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <span
                className={`inline-block mt-1.5 px-2 py-0.5 text-xs font-medium rounded-full ${aluna.status === "Ativa" ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-700"
                  }`}
              >
                {aluna.status}
              </span>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-black text-white rounded-lg text-sm font-semibold hover:bg-zinc-900 transition-colors flex items-center justify-center gap-1.5"
                >
